-- Allow signing up a coach-role profile as a participant in a session (e.g. a coach
-- training as an athlete), while still blocking a coach from being added to a
-- session they themselves coach.
