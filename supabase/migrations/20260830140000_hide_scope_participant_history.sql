-- Reports/Athlete-activity history now respects hide_from_coach / hide_from_manager
-- on the app-registration branch (manual participants are unaffected — hiding
-- never applies to them). Body copied from
-- 20260628140000_family_report_unified_history.sql (current definition) with
-- viewer-role-aware scope filtering added.
