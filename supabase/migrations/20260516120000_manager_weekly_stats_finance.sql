-- Weekly dashboard: coach payouts + athlete expected/collected/outstanding (arrived slots + account payments in week).
...
begin
  ...
  from (
    ...
    acct_by_ath as (
      ...
      where a.paid_at between v_week_start and v_end
      group by 1, 2
    ),
    ath_keys as (
