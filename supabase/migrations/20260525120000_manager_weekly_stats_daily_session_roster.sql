-- Adds registered/arrived/late-cancel counts to daily collection session rows.
-- Safe to run if 20260524120000 was already applied.
...
begin
  ...
  v_finance := (v_finance::jsonb || jsonb_build_object('collections_by_day', v_collections_by_day::jsonb))::json;
